...
public class BinaryTree<E> {
	 ...
	 * Missing code 2 as its left subtree 
	...
	public BinaryTree(E data, BinaryTree<E> leftTree, BinaryTree<E> rightTree) {
		...
		if (leftTree != null) {
			root.left = leftTree.root.left;
		} else {
			root.left = null;
		}
		
		if (rightTree != null) {
		root.right = rightTree.root.right;
		} else {
			root.right = null;
		}
	 ...
	 * 
	 * @pre The input consists of a preorder traversal of the binary tree. The line
	...
	/*
	 * <exercise Lab Assignment 6 - Programming exercise 2/ /** Method to return the
	 * preorder traversal of the binary tree as a sequence of strings each separated
	 * by a space.
	 * 
	...
	/*
	 * <exercise Lab Assignment 6 - Programming exercise 3/ /** Method to return the
	 * postorder traversal of the binary tree as a sequence of strings each
	...
	/*
	 * <exercise Lab Assignment 6-Programming exercise 4/ /** A method to display
	 * the inorder traversal of a binary tree placing a left parenthesis before each
	 * subtree and a right parenthesis after each subtree. For example the
	 * expression tree shown in the Figure would be represented as (((x) + (y)) *
	 * ((a) / (b))).
	 * 
